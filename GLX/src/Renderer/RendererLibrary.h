...
public:
    ...
    void CreatePlaneVBO();
    VertexBuffer& GetPlaneVBO()
    {
        return m_PlaneVBO;
    }
    float* GetPlaneVertices()
    {
        return m_PlaneVertices;
    }

    void CreateSphereData();
    VertexBuffer& GetSphereVBO()
    {
        return m_SphereVBO;
    }
    IndexBuffer& GetSphereEBO()
    {
        return m_SphereEBO;
    }
    ...
    GLuint& GetSphereIndicesCount()
    {
        return m_SphereIndicesCount;
    }
};